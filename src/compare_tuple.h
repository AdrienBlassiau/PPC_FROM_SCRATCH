...
#ifndef ALGORITHM_COMPARE_TUPLE_H
#define ALGORITHM_COMPARE_TUPLE_H
 ...
 * @return               A negative value if the first tuple should be
 *                       sorted before the second, a positive value if the
 *                       first tuple should be sorted after the second,
 *                       zero if the two tuples are equal.
 */
